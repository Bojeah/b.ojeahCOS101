fn main() {
   ...
   println!();
   println!("{} is aimed at developing competent, creative, innovative, entrepreneurial and ethniacally-minded persons, capable of creating value in the diverse fields of Computer science", w3);
